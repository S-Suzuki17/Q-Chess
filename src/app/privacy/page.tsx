  ...
  return (
    <div className="h-[100dvh] w-full bg-[#050505] text-gray-300 font-mono p-6 md:p-12 overflow-y-auto">
      <div className="max-w-3xl mx-auto pb-16">
        <Link href="/" className="text-[#D4B872] hover:text-white transition-colors tracking-widest font-bold text-sm mb-8 inline-block">&larr; Back to Q-GAMBIT</Link>

        <h1 className="text-3xl md:text-4xl font-bold text-[#D4B872] tracking-wider mb-2">Privacy Policy</h1>
        <p className="text-gray-500 text-sm mb-8">Last updated: August 23, 2026</p>

        <div className="flex flex-col gap-8 text-sm leading-relaxed">

          <section>
            <h2 className="text-xl font-bold text-white border-b border-[#3A3224] pb-1 mb-2">1. Introduction</h2>
            <p>
          ...
          <section>
            <h2 className="text-xl font-bold text-white border-b border-[#3A3224] pb-1 mb-2">2. Information We Collect</h2>
          ...
          <section>
            <h2 className="text-xl font-bold text-white border-b border-[#3A3224] pb-1 mb-2">3. Third-Party Services</h2>
            <p className="mb-2">The Service uses the following third-party services that may collect information:</p>
            <ul className="list-disc list-inside flex flex-col gap-2 ml-2">
              <li><strong className="text-gray-200">Google AdSense:</strong> We use Google AdSense to display advertisements. Google may use cookies and web beacons to serve ads based on your prior visits to this or other websites. You can opt out of personalized advertising by visiting <a href="https://www.google.com/settings/ads" target="_blank" rel="noopener noreferrer" className="text-[#D4B872] hover:text-white transition-colors hover:underline">Google Ads Settings</a>.</li>
          ...
          <section>
            <h2 className="text-xl font-bold text-white border-b border-[#3A3224] pb-1 mb-2">4. Cookies</h2>
            <p>
          ...
          <section>
            <h2 className="text-xl font-bold text-white border-b border-[#3A3224] pb-1 mb-2">5. Data Retention</h2>
            <p>
          ...
          <section>
            <h2 className="text-xl font-bold text-white border-b border-[#3A3224] pb-1 mb-2">6. Children&apos;s Privacy</h2>
            <p>
          ...
          <section>
            <h2 className="text-xl font-bold text-white border-b border-[#3A3224] pb-1 mb-2">7. Changes to This Policy</h2>
            <p>
          ...
          <section>
            <h2 className="text-xl font-bold text-white border-b border-[#3A3224] pb-1 mb-2">8. Contact</h2>
            <p>
              If you have any questions about this Privacy Policy, please contact us through our GitHub repository: <a href="https://github.com/S-Suzuki17/Q-Chess" target="_blank" rel="noopener noreferrer" className="text-[#D4B872] hover:text-white transition-colors hover:underline">github.com/S-Suzuki17/Q-Chess</a>
            </p>
          </section>
