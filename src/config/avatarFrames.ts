import {FOUNDERS_FRAME} from './founders';
...
export const avatarFrame=(id:string|undefined)=>id===FOUNDERS_FRAME.id?FOUNDERS_FRAME:AVATAR_FRAMES.find(frame=>frame.id===id);
