...
export const CIRCUIT_MUSIC = [
    ...
    {id:'astral', url:'/audio/rewards/Banjou_no_Kikagaku.mp3', boss:undefined, requiredWins:5},
    {id:'zenith', url:'/audio/rewards/Twelve_Moves_Ahead.mp3', boss:undefined, requiredWins:10},
    {id:'valkyrie', url:'/audio/rewards/The_Eighth_Rank.mp3', boss:undefined, requiredWins:20},
] as const;
